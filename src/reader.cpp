...
stack<Data> Reader::splitEuroparlDocumentIntoParagraphs( const char * filename1,  const char * filename2)
{
    //regex for chapter tags
    boost::regex chapter_tag( "<CHAPTER\\s+ID=\"?(\\d*)\"?>" );
...
stack<Data> Reader::splitEuroparlDocumentIntoSpeakers( const char * filename1, const char * filename2)
{
    //regex for chapter tags
...
stack<Data> Reader::splitEuroparlDocumentIntoChapters(const char * filename1, const char * filename2)
{
    //regex for chapter tags
    regex chapter_tag( "<CHAPTER\\s+ID=\"?(\\d*)\"?>" );
    regex speaker_tag("^<SPEAKER\\s+ID=\"?(\\d*)\"?");
...
Data Reader::readNumberedEuroparlDocument( const char * filename_1, const char * filename_2 )
{
    ...
    else
    {
        ...
        itr_ss++, itr_ssp++ )
        {
            ...
            Sentence source_sentence_temp = Sentence(position,
    ...
    else
    {
        ...
        itr_ts++, itr_tsp++ )
        {
            ...
            Sentence target_sentence_temp = Sentence(
                    position,
                    static_cast<int>(sentence.size()),
                    countWordsInSentence,
                    int_token);
...
//    vector<string> t;
    ...
    else
    {
        ...
        itr_ss++, itr_ssp++ )
        {
            ...
            Sentence source_sentence_temp = Sentence(
            		position,
					static_cast<int>(sentence.size()),
					count_words_in_sentence,
					int_token);
